...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Smart Traffic</span></a></h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Mari ikut menjaga polusi udara dengan aplikasi <span>Smart Traffic</span></h1>
            <h2>Navigasi Cerdas dan Udara Sehat Bersama Smart Traffic</h2>
            <div class="text-center text-lg-start">
              <a href="#about" class=""><img class="w-25" src="{{asset('assets/img/Play Store.svg')}}"></a>
            </div>
          </div>
        </div>
        ...
        <div class="row g-0" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
              <a href="a{{asset('assets/img/gallery/gallery-6.jpg')}}" class="gallery-lightbox">
                <img src="a{{asset('assets/img/gallery/gallery-6.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="{{asset('assets/img/team/team-3.jpeg')}}" class="img-fluid" alt=""></div>
              <div class="member-info">
